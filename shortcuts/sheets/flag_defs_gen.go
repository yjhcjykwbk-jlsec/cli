...
var flagDefs = map[string]commandDef{
	...
	"+chart-config-update": {
		...
		Flags: []flagDef{
			...
			{Name: "aggregate-categories", Kind: "own", Type: "bool", Required: "optional", Desc: "Whether to aggregate duplicate categories; pass false for sparse markers or row-level data points, and omit it to preserve the current setting"},
	...
	"+chart-create-basic": {
		...
		Flags: []flagDef{
			...
			{Name: "aggregate-categories", Kind: "own", Type: "bool", Required: "optional", Desc: "Whether to aggregate duplicate categories; pass false for sparse markers or row-level data points, and omit it to use the chart default"},
